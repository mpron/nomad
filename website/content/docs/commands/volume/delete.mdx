...
will also be [deregistered][] when it is successfully deleted.

For dynamic host volumes, only volumes with plugins will be deleted. Volumes
without plugins will be deregistered without deleting them.
